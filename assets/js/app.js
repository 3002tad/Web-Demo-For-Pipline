TrackingSDK.init({
    ...
    function expandCatalogProducts(targetCount) {
      ...
      const prefixes = ["Bộ sưu tập", "Phiên bản", "Sản phẩm", "Combo", "Máº«u má»›i", "HÃ ng chá»n lá»c", "Æ¯u Ä‘Ã£i"];
      ...
      while (products.length < targetCount) {
        ...
        products.push({
          ...
          description: `Sản phẩm ${category.toLowerCase()} Ä‘Æ°á»£c tuyá»ƒn chá»n bá»Ÿi ${suppliers[category].name}, phÃ¹ há»£p cho nhu cáº§u mua sáº¯m háº±ng ngÃ y.`
        });
      ...
      detailContent.innerHTML = `
        <div class="detail-layout">
          <div class="detail-media">
            <img src="${product.image}" alt="${product.name}">
            <div class="thumb-row" aria-label="ảnh sáº£n pháº©m phá»¥">
              <span>ảnh 1</span>
              <span>ảnh 2</span>
              <span>ảnh 3</span>
              <span>Video</span>
          ...
          <div class="detail-info">
            ...
            <div class="detail-section">
              <strong>Vận chuyển & báº£o hÃ nh</strong>
            ...
            <div class="card-actions">
              ...
              <button class="primary-button" type="button" data-add-id="${product.id}" data-track-name="detail_add_${product.id}">Thêm giá»</button>
            </div>
          </div>
        </div>
        <div class="detail-section" style="margin-top:18px;">
          <strong>Mô tả sáº£n pháº©m</strong>
          <p class="muted">${product.description} Sản phẩm thuá»™c gian hÃ ng ${product.supplier.name}, cÃ³ thÃ´ng tin váº­n chuyá»ƒn, Ä‘á»•i tráº£ vÃ  nhÃ  cung cáº¥p rÃµ rÃ ng Ä‘á»ƒ báº¡n yÃªn tÃ¢m trÆ°á»›c khi Ä‘áº·t hÃ ng.</p>
        </div>
        <div class="detail-section" style="margin-top:12px;">
          <strong>Sản phẩm liÃªn quan</strong>
